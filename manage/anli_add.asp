...
<table width="90%" border=0 align=center cellSpacing=1 class="navi">
    ...
    <tr>
      ...
      <td height="20" bgcolor="#FFFFFF" class="front3"><iframe id="1" src="upfile1.asp?path=product&name=image" frameborder="0" scrolling="No" width="350" height="25"></iframe></td>
    </tr>
	<tr>
      <td height="20" align="right" bgcolor="#FFFFFF" class="front3">案例地址<span class="STYLE5">：</span></td>
      <td height="20" bgcolor="#FFFFFF" class="front3"><input name="link1" type="text" style="height:14px;" /></td>
    </tr>					   
    <tr bgcolor="#A4B6D7">
...
if request("action")="aa" then
		...
		rs1("productclass")=request("BigClassName")'产品类别
		rs1("path")=request("image")'产品的存放文件名
		rs1("link")=request("link1")'产品的连接地址
		rs1.update
		rs1.requery
		rs1.close
		set rs1=nothing
	Response.Write "<script>alert('您已经成功添加');location='anli_add.asp'</script>"
end if	
%>
</body>
</html>
