...
<table width="90%" border=0 align=center cellSpacing=1 class="navi">
    ...
    <tr>
      ...
      <td colspan="2" align="left" bgcolor="#FFFFFF"><select name="newsid" id="newsid">
	  <%
...
if request("action")="aa" then
	...
	rs("content")=request("theme")
	rs("newsid")=request("newsid")
	...
	Response.Write "<script>alert('您已经成功添加');location='news_add.asp'</script>"
end if	
%>
</body>
</html>
