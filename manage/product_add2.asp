...
%>
      ...
      <td width="934" height="20" colspan="2" bgcolor="#FFFFFF"><input name="price" type="text" id="price" style="width:300px;"></td>
    </tr>
	    <tr>
      <td width="126"  height="20" align="right" bgcolor="#FFFFFF" class="STYLE5"><div align="right">参数2</div></td>
      ...
      <td width="934" height="20" colspan="2" bgcolor="#FFFFFF"><input name="dj" type="text" id="dj" style="width:300px;"></td>
    </tr>
	    <tr>
      <td width="126"  height="20" align="right" bgcolor="#FFFFFF" class="STYLE5"><div align="right">参数5：</div></td>
      <td width="934" height="20" colspan="2" bgcolor="#FFFFFF"><input name="cd" type="text" id="cd" style="width:300px;"></td>
    </tr>
	    <tr>
      <td width="126"  height="20" align="right" bgcolor="#FFFFFF" class="STYLE5"><div align="right">参数2：</div></td>
      <td width="934" height="20" colspan="2" bgcolor="#FFFFFF"><input name="xh" type="text" id="xh" style="width:300px;"></td>
    </tr>-->
    <tr>
...
max=1
		...
		rs1.close
		set rs1=nothing
	Response.Write "<script>alert('您已经成功添加');location='product_add.asp'</script>"
end if	
%>
</body>
</html>
