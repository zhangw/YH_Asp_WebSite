...
<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
  <tr bgcolor="#e0e9f8" class="unnamed1">
    <th width="78" bgcolor="#e0e9f8"  class="STYLE5">用户名</th>
    <th width="217" bgcolor="#e0e9f8"  class="STYLE5">公司名称</th>
    <th width="60" bgcolor="#e0e9f8"  class="STYLE5">联系人</th>
    <th width="109" height="20" bgcolor="#e0e9f8"  class="STYLE5"><div align="center">电话</div></th>
    <th width="87" bgcolor="#e0e9f8"  class="STYLE5"><div align="center">所属类别</div></th>
    <th width="89" bgcolor="#e0e9f8"  class="STYLE5">注册时间</th>
    <th width="99" bgcolor="#e0e9f8"  class="STYLE5">最后登录时间</th>
    <th width="101" bgcolor="#e0e9f8"  class="STYLE5">推荐</th>
    <th width="126" bgcolor="#e0e9f8"  class="STYLE5">会员状态</th>
...
%>
  <tr <%if RowCount mod 2=0 then%>bgColor="#fffff0"<%else%>bgcolor="#F6F6F6"<%end if%> class="unnamed1">
    <td width="78" align="center"  class="STYLE5" style="padding-left:5px;"><%=rs("admin")%></td>
    <td width="217" align="center"  class="STYLE5" style="padding-left:5px;"><%=rs("company")%></td>
    <td width="60" align="center"  class="STYLE5" style="padding-left:5px;"><%=rs("xm")%></td>
    <td width="109" height="20" align="center"  class="STYLE5" style="padding-left:5px;"><%=rs("qh1")%>-<%=rs("dh1")%></td>
	<td width="87" align="center"  class="STYLE5"><div align="center"><%=rs("class")%></div></td>
    <td align="center"  class="STYLE5"><%=rs("time")%></td>
    <td align="center"  class="STYLE5"><%=rs("ztime")%></td>
    <td align="center"  class="STYLE5"><%if rs("tj")=1 then%>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <form id="formm" name="formm" method="post" action="?action=editsave&id=<%=request("id")%>&page=<%=request("page")%>">
      <tr>
      ...
      <tr>
        ...
        <td align="left" class="css"><input name="sex" type="radio" value="先生" <%if rs("sex")="先生"then%>checked="checked"<%end if%> />
          先生
            <input type="radio" name="sex" value="女士" <%if rs("sex")="女士"then%>checked="checked"<%end if%>/>
            女士</td>
        </tr>
      <tr>
...
<input name="dh2" type="text" id="dh2" value="<%=rs("dh2")%>"/></td>
	...
	<tr>
        ...
        <td height="30" align="left"><input name="image" type="hidden" id="image" value="<%=rs("pic")%>"/><iframe id="1" src="upfile1.asp?path=product&name=image" frameborder="0" scrolling="No" width="300" height="25"></iframe></td>
      </tr>
      <tr>
