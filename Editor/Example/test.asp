...
<TR>
	<TD>编辑内容：</TD>
	<TD>
		<INPUT type="hidden" name="content1" value="<p>&nbsp;</p><p><font color=#ff0000>本样式为自带默认样式，最佳调用宽度550px，高度350px！</font></p><p>下面为一些级调用功的例子，你可以用脚本方便的编辑进行一些操作。</p><p>看到这些内容，且没有错误提示，说明安装已经正确完成！</p><p>你可以先到后台管理中，进行必要的设置，然后再调用！</p><p><b><font color=#0000ff>提示：</font>别忘了改用户和密码、数据库文件名。</b></p>">
		<IFRAME ID="eWebEditor1" src="../ewebeditor.asp?id=content1&style=standard_coolblue" frameborder="0" scrolling="no" width="550" height="350"></IFRAME>
	</TD>
</TR>
<TR>
